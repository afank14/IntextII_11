...
namespace IntexII_11.Migrations
{
    ...
    [Migration("20240411164528_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IntexII_11.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("IntexII_11.Models.LineItem", b =>
                {
            ...
            modelBuilder.Entity("IntexII_11.Models.Order", b =>
                {
                    b.Property<int>("order_ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("predicted_fraud")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("IntexII_11.Models.Product", b =>
                {
                    b.Property<int>("product_ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IntexII_11.Models.User60Rec", b =>
                {
                    b.Property<int?>("product_ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IntexII_11.Models.LineItem", b =>
                {
                    b.HasOne("IntexII_11.Models.Order", "Order")
                        .WithMany()
                        .HasForeignKey("order_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IntexII_11.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("IntexII_11.Models.Order", b =>
                {
                    b.HasOne("IntexII_11.Models.Customer", "Customer")
                        .WithMany()
